...
# Install mc/Neofetch/HTOP
sudo apt install -y mc neofetch htop

# Install other
sudo apt install -y ueberzug firefox-esr xwallpaper sxiv libxkbcommon-dev libxkbcommon-x11-dev
